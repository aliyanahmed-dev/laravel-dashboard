    ...
    <div class="row second-chart-list third-news-update">
        <div class="col-xl-12 xl-100 dashboard-sec box-col-12">
            <div class="card">
                ...
                <form class="form theme-form bold-labels" action="{{ route('batches.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="text" required name="name" value="{{ old('name') }}" placeholder="Batch Name" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="text" required name="batch_id" value="{{ old('batch_id') }}" placeholder="Batch ID" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="number" required name="limit" value="{{ old('limit') }}" placeholder="Batch Limit" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer text-end">
                        <div class="col-sm-9 offset-sm-3">
                            <button class="btn btn-primary" type="submit" data-bs-original-title="" title="">Add Batch</button>
