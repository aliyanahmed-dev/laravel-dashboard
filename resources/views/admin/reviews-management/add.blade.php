    ...
    <div class="row second-chart-list third-news-update">
        <div class="col-xl-12 xl-100 dashboard-sec box-col-12">
            <div class="card">
                ...
                <form class="form theme-form bold-labels" action="{{ route('students_store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="text" required name="name" value="" placeholder="Student Name" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="email" required name="email" value="" placeholder="Student Email" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="text" required name="password" value="" placeholder="Student Password" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="tel" required name="phone" value="" placeholder="Student Contact Number" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                ...
                                                <select name="pay_status" id="" class="form-control">
                                                    ...
                                                    <option value="paid" {{ (old('pay_status') == '1') ? 'selected' : '' }}>Paid</option>
                                                    <option value="unpaid" {{ (old('pay_status') == '0') ? 'selected' : '' }}>Un-Paid</option>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="">
                                                <input class="form-control" type="number" name="fees_amount" value="{{old('fees_amount')}}" placeholder="Student Fees Amount" data-bs-original-title="" title="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="card-footer text-end">
            <div class="col-sm-9 offset-sm-3">
                <button class="btn btn-primary" type="submit" data-bs-original-title="" title="">Add Student</button>
